function [ub_cost,ub_time,optca_mat,tot_run_time] = compute_ub_fv_mip(filename)
...
for k = 1:numSamples
    ...
    for t = 1:168
        ...
        iwgdx('ubdata.gdx','u_prev',[u_prev;0;0],'z_prev',[z_prev;0;0],...
            ...
            'Voff',Voff,'dj',x_s(t,:)');
        [status,result]=system(['gams subgrad_ub_fv_mip --probdata=',...
