...
%   Y = mynormpdf(X,MU,SIGMA) returns the pdf of the normal distribution with
...
if nargin<1
    error('stats:mynormpdf:TooFewInputs','Input argument X is undefined.');
end
if nargin < 2
    mu = 0;
end
...
try
    ...
    error('stats:mynormpdf:InputSizeMismatch',...
